...
def main():
    ...
    if creds is False and selected == 1 or creds and selected == 2:
        ...
        if isinstance(tmp2, tuple):
            ...
            country = requests.get('https://restcountries.eu/rest/v2/callingcode/' + str(tmp2['data'][0]['phones'][0]['dialingCode'])).json()[0]['name']
...
if __name__ == '__main__':
    ...
    try:
        ...
        time.sleep(0.4)
        exit(lired + '[!] Exiting'.center(os.get_terminal_size().columns))
    main()
